...
CREATE OR REPLACE API INTEGRATION git_api_integration
  ...
  --  ALLOWED_AUTHENTICATION_SECRETS = (git_secret) --- for private repository
  ENABLED = TRUE;
...
CREATE OR REPLACE GIT REPOSITORY quickstart_common.public.quickstart_repo
  ...
  --GIT_CREDENTIALS = git_secret   --- for private repository
...
CREATE or replace TABLE QUICKSTART__{{environment}}.SILVER.customers_new1 (
  id number not null, 
  first_name varchar, 
  last_name varchar
);
